...
<?php
       			...
       			echo "<table class='table'>";
	       			...
	       			$query_armazon_3piezas = "select count(*) as 3Piezas from pedido where armazon = '3piezas' and fecha>='$fecha' and fecha<='$fecha2'";
				...
				<?php 	while ($row = mysql_fetch_array($rs)) { ?>
							<tr>
  							...
  							<tr>
  								...
  								<td colspan="11"><?php echo $row['descripcion']; ?> </td>
  							</tr>
        					<tr>
          						<td></td>
          						<td colspan="12"> </td>
