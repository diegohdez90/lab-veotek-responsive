...
<body>
	...
	<div class="container">
		<div class=" header row">
			<div class="col-md-8">
				<h3>Bienvenidos al Laboratorio de Reparaciones de Veotek</h3>
			</div>
			<div class="col-md-4">';
	                 ...
	                 <!-- Carousel items -->
	                    <div class="carousel fdi-Carousel slide" id="eventCarousel" data-interval="0">
	                        <div class="carousel-inner onebyone-carosel">
	                            ...
	                            <div class="item">
	                                <div class="col-xs-4">
	                                    <span class="glyphicon glyphicon-log-out" style="font-size:88px;"></span>
	                                    <div><p class="text-center">Salidas</p></div>
	                                </div>
	                            </div>
	                            <div class="item">
	                                <div class="col-xs-4">
	                                    <span class="glyphicon glyphicon-refresh" style="font-size:88px;"></span>
	                                    <div><p class="text-center">Modificar</p></div>
	                                </div>
	                            </div>
	                            <div class="item">
	                                <div class="col-xs-4">
	                                    <span class="glyphicon glyphicon-list-alt" style="font-size:88px;"></span>
	                                    <div><p class="text-center">Pedidos</p></div>
	                                </div>
	                            </div>
	                            <div class="item">
	                                <div class="col-xs-4">
	                                    <span class="glyphicon glyphicon-folder-open" style="font-size:88px;"></span>
	                                    <div><p class="text-center">Informes</p></div>
	                                </div>
	                            </div>
	                            <div class="item">
	                                <div class="col-xs-4">
	                                    <span class="glyphicon glyphicon-search" style="font-size:88px;"></span>
